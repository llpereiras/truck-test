...
ActiveRecord::Schema.define(version: 20171004172609) do
  ...
  create_table "shipments_vehicles", force: :cascade do |t|
    t.integer "shipment_id"
    t.integer "vehicle_id"
    t.index ["shipment_id"], name: "index_shipments_vehicles_on_shipment_id"
    t.index ["vehicle_id"], name: "index_shipments_vehicles_on_vehicle_id"
  end
